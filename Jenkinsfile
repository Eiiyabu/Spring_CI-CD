pipeline {
  ...
  environment {
    ...
    NEXUS_URL   = 'http://192.168.244.135:8081/repository/maven-snapshots/'
  }
...
EOF'''
      ...
      sh 'mvn deploy -B -s settings.xml -DaltDeploymentRepository=nexus::http://192.168.244.135:8081/repository/maven-snapshots/'
    }
  }
}
  }
